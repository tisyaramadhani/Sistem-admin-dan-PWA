                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url($ssw['nama_course']) ?>" class="btn btn-warning btn-sm" class="btn btn-warning btn-sm">
                                <i class="fas fa-book-open"></i>
                            </a>
                            <button data-toggle="modal" data-target="#edit<?php echo $ssw['id_coursecategory'] ?>" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i></button>
                            <a href="<?= base_url('course/delete/' .$ssw['id_coursecategory']) ?>" class="btn btn-danger btn-sm">
