                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button data-toggle="modal" data-target="#edit<?php echo $ssw['id_course'] ?>" class="btn btn-warning btn-sm">
                            ...
                            <a href="<?= base_url('keperawatanx/delete/' . $ssw['id_course']) ?>" class="btn btn-danger btn-sm">
...
<!-- tambah -->
<?php foreach ($keperawatanx as $ssw) : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('keperawatanx/tambah_aksi') ?>" method="POST">
    ...
    <div class="modal fade" id="edit<?php echo $ssw['id_course'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('keperawatanx/edit/' . $ssw['id_course']) ?>" method="POST">
                    <div class="form-group">
                            <label>id</label>
