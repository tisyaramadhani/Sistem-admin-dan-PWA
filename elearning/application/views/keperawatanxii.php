                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button data-toggle="modal" data-target="#edit<?php echo $ssw['id_course'] ?>" class="btn btn-warning btn-sm">
                            ...
                            <a href="<?= base_url('keperawatanxii/delete/' . $ssw['id_course']) ?>" class="btn btn-danger btn-sm">
...
<!-- tambah -->
<?php foreach ($keperawatanxii as $ssw) : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('keperawatanxii/tambah_aksi') ?>" method="POST">
    ...
    <div class="modal fade" id="edit<?php echo $ssw['id_course'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('keperawatanxii/edit/' . $ssw['id_course']) ?>" method="POST">
                    <div class="form-group">
                            <label>id</label>
